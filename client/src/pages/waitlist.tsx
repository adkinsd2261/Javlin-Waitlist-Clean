          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white/5 rounded-3xl p-8 border border-white/10 relative">
                ...
                <Button className="w-full bg-white/10 hover:bg-white/15 text-white border border-white/20 hover:border-white/30 py-3 rounded-xl transition-all duration-200">
                  Get Started Free
                </Button>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#5151FF]/20 to-[#6a5cff]/20 rounded-3xl p-8 border border-[#5151FF]/30 relative">
                ...
                <Button className="w-full bg-[#5151FF] hover:bg-[#6a5cff] text-white py-3 rounded-xl transition-all duration-200 shadow-lg shadow-[#5151FF]/25">
                  Choose Pro
                </Button>
              </div>
            ...
            {/* Founders Special */}
            <div className="bg-gradient-to-r from-[#5151FF]/10 to-[#6a5cff]/10 rounded-3xl p-8 lg:p-12 border border-[#5151FF]/20 text-center">
